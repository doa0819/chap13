...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. 다양한 타입의 예외를 multi block 을 이용해서 치리할 수 있다. */
        /* 필기.
        ...
        *
        *
        * -> 상위 타입이 위에 있으면 아래 타입들이 오류가 난다 (제일 하단에 있으면 상관없다.  )*/
        ...
        try {
            ...
            // 예외 인스턴스 생성 기 전달한 메세지를 getMessage() 로 호출할 수 있다.
