...
//    @Override
//    public void method() throws Exception{}    // exception -> supercalss -> subclass => super 를 안거치고 exception 으로 바로 갈수 없다

    // 하지만 부모의 예외처리 클래스 보다 더 하위에 있는 예외(즉 더 구체적인 예외상황) 인 경우 오버라이딩 가능

    @Override
    public void method() throws FileNotFoundException{}   //정상   -> 부모의 클래스 보다 하위 클래스 여서 가능
